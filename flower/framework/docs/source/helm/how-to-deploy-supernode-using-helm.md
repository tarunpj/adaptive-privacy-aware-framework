...
| `supernode.service.servicePortClientAppIoName`                      | Prefix of the SuperNode Runtime API port                                                                                | `clientappio`              |
| `supernode.service.servicePortClientAppIo`                          | Port to expose for the SuperNode Runtime API                                                                            | `9094`                     |
| `supernode.service.nodePortClientAppIo`                             | Node port for the SuperNode Runtime API                                                                                 | `""`                       |
| `supernode.containerPorts.clientAppIo`                              | Container port for the SuperNode Runtime API                                                                            | `9094`                     |
...
| `supernode.appioTls.enabled`                                        | Enable TLS on the SuperNode Runtime API.                                                                                | `false`                    |
| `supernode.appioTls.caCertfile`                                     | Path to the CA certificate used by SuperExec to verify the Runtime API.                                                 | `/app/cert/ca.crt`         |
| `supernode.appioTls.certfile`                                       | Path to the Runtime API server certificate.                                                                             | `/app/cert/tls.crt`        |
| `supernode.appioTls.keyfile`                                        | Path to the Runtime API server private key.                                                                             | `/app/cert/tls.key`        |
